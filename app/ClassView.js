/*
This class handles the Class view
*/

praxis.ClassView = Class.extend({
    ...
    hide: function(){
        ...
        if(app.classView.grid != undefined && app.classView.classData != undefined)
        {
            var columns = app.classView.grid.getColumns();
            var classData = app.classView.classData;
    ...
    showClass: function(classData){
      ...
      */
          ...
          moveRowsPlugin.onMoveRows.subscribe(function (e, args) {
            ...
            app.classView.classData.fields = data;
        ...
        grid.onAddNewRow.subscribe(function (e, args) {
            var item = args.item;
            grid.invalidateRow(classData.fields.length);
            classData.fields.push(item);
            grid.updateRowCount();
            grid.render();
        });
    },
